...
#define CL_STATUS_TRUNCATED_THREAD_NAME					   (ERROR_MASK | CUSTOMER_BIT | DEVICE_MASK  | 0x0036UL)
...
#define STATUS_TRUNCATED_THREAD_NAME					CL_STATUS_TRUNCATED_THREAD_NAME
